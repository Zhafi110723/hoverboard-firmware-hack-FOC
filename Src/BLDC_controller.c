  ...
  if (rtAction == 0) {
    ...
    switch (rtAction) {
     ...
     case 2:
      ...
      if (tmp_0 >= rtb_Divide1_g) {
        ...
        rtb_Switch4_idx_0 = rtb_Switch4_idx_1;
      }
       ...
       *  Product: '<S108>/IProd Out'
       */
      rtb_RelationalOperator_h = (rtb_Switch4_idx_0 != 0);
       ...
       *  Sum: '<S65>/Sum2'
       */
      rtb_Switch4_idx_0 = (int16_T)((tmp * rtP->cf_iqKi) >> 16);
      ...
      /* SignalConversion: '<S65>/Signal Conversion2' incorporates:
       *  Switch: '<S119>/Switch2'
       */
      *rty_Vq = rtb_Divide1_g;
       ...
       *  Switch: '<S100>/Switch'
       */
      tmp = localDW->Integrator_DSTATE + rtb_Switch4_idx_0;
      if (tmp > 32767) {
        tmp = 32767;
      } else if (tmp < -32768) {
        tmp = -32768;
    ...
    if (rtAction == 0) {
      if (rtPrevAction != 0) {
         ...
         */
        localDW->Integrator_DSTATE_k = localDW->constant2;
       ...
       */
      tmp += localDW->Integrator_DSTATE_k;
      if (tmp > 32767) {
        tmp = 32767;
      } else if (tmp < -32768) {
        tmp = -32768;
       ...
       *  Switch: '<S161>/Switch'
       */
      rtb_Switch4_idx_0 = (int16_T)(tmp - rtb_Switch4_idx_0);
       ...
       *  Switch: '<S158>/Switch2'
       */
      if ((rtb_Switch4_idx_0 != 0) && (rtAction == rtPrevAction)) {
        rtb_Divide1_g = 0;
      }
       ...
       *  Switch: '<S158>/Switch'
       */
      tmp = localDW->Integrator_DSTATE_k + rtb_Divide1_g;
      if (tmp > 32767) {
        tmp = 32767;
      } else if (tmp < -32768) {
        tmp = -32768;
      ...
      localDW->Integrator_DSTATE_k = (int16_T)tmp;
...
void BLDC_controller_step(RT_MODEL *const rtM)
{
  ...
  if (!rtP->b_angleMeasEna) {
    ...
    if (rtb_LogicalOperator) {
      ...
      if (rtDW->Switch3 <= rtDW->z_counterRawPrev) {
        rtb_Merge1 = rtDW->Switch3;
      } else {
        rtb_Merge1 = rtDW->z_counterRawPrev;
      }

      rtDW->Merge_c = (int16_T)(((int16_T)((int16_T)((rtb_Merge1 << 14) /
        rtDW->z_counterRawPrev) * rtDW->Switch2_a) + (rtb_Sum2_ii << 14)) >> 2);
    } else {
      rtDW->Merge_c = (int16_T)(rtb_Sum2_ii << 12);
    }
     ...
     *  Product: '<S14>/Divide2'
     */
    rtDW->Merge_c = (int16_T)((15 * rtDW->Merge_c) >> 4);
     ...
     *  Sum: '<S19>/Sum3'
     */
    rtDW->Merge_c = (int16_T)(rtDW->Sum1 - ((int16_T)((int16_T)div_nde_s32_floor
  ...
  if (UnitDelay3 == 0) {
    ...
    if (rtP->z_selPhaCurMeasABC == 0) {
       ...
       *  Saturate: '<S1>/Saturation1'
       */
      rtDW->Switch1_m = ((18919 * rtDW->Saturation) >> 15) + (int16_T)((18919 *
        rtDW->Saturation1) >> 14);
       ...
       *  Saturate: '<S1>/Saturation1'
       */
      rtDW->Switch1_m = rtDW->Saturation - rtDW->Saturation1;
      if (rtDW->Switch1_m > 32767) {
        rtDW->Switch1_m = 32767;
      } else if (rtDW->Switch1_m < -32768) {
        rtDW->Switch1_m = -32768;
      ...
      rtDW->Saturation = (int16_T)rtDW->Switch1_m;
       ...
       *  Saturate: '<S1>/Saturation'
       */
      rtDW->Switch1_m = 18919 * rtDW->Saturation;

      /* Gain: '<S57>/Gain2' incorporates:
       *  Saturate: '<S1>/Saturation1'
       */
      rtDW->Sum1 = 18919 * rtDW->Saturation1;
     ...
     *  Merge: '<S3>/Merge'
     */
    rtb_k_o = plook_u8s16u16n15_even7ca_gs(rtDW->Merge_c, 0, &rtb_f);
    ...
    if (UnitDelay3 == 0) {
       ...
       *  Product: '<S54>/Divide3'
       */
      rtDW->Switch1_m = (int16_T)((rtDW->Saturation * rtDW->r_cos_M1_1) >> 14) +
  ...
  if (rtDW->UnitDelay2_DSTATE_g) {
    ...
    if (rtU->r_inpTgt > 16000) {
      rtDW->Saturation = 16000;
    } else if (rtU->r_inpTgt < -16000) {
      rtDW->Saturation = -16000;
    } else {
      rtDW->Saturation = rtU->r_inpTgt;
    }
    ...
    if (rtP->z_ctrlTypSel == 2) {
       ...
       */
      rtDW->Saturation = (int16_T)(((uint16_T)((rtDW->iv[rtU->z_ctrlModReq] << 5)
        / 125) * rtDW->Saturation) >> 12);
    ...
    if (UnitDelay3 == 0) {
       ...
       *  Switch: '<S43>/Switch1'
       */
      rtDW->Sum1_o = ((uint32_T)-rtDW->Switch1_m & 134217728U) != 0U ?
       ...
       *  Sum: '<S41>/Sum1'
       */
      if (rtDW->Sum1_o > rtP->dV_openRate) {
        rtDW->Sum1_o = rtP->dV_openRate;
      } else {
        /* Gain: '<S37>/Gain3' */
        rtDW->Gain3 = ((uint32_T)-rtP->dV_openRate & 134217728U) != 0U ?
         ...
         *  Switch: '<S44>/Switch2'
         */
        if (rtDW->Sum1_o < rtDW->Gain3) {
          rtDW->Sum1_o = rtDW->Gain3;
        }
    ...
    FOC(rtP->z_ctrlTypSel, rtb_LogicalOperator, rtDW->z_ctrlMod, rtDW->Merge1,
        ...
        rtDW->Switch2_b, rtDW->Switch2_p, rtDW->Divide1, rtDW->Switch2_gd,
      rtDW->UnitDelay4_DSTATE_a, rtP->b_cruiseCtrlEna, rtP, &rtDW->Merge,
        &rtDW->Switch2_g, &rtDW->FOC_h);
    ...
    if (rtP->b_fieldWeakEna) {
      ...
      /* Abs: '<S45>/Abs5' */
      if (rtU->r_inpTgt < 0) {
        rtb_Abs5 = (int16_T)-rtU->r_inpTgt;
      } else {
        rtb_Abs5 = rtU->r_inpTgt;
      }
       ...
       *  Switch: '<S47>/Switch'
       */
      if (rtb_Abs5 > rtP->r_fieldWeakHi) {
        rtb_Abs5 = rtP->r_fieldWeakHi;
      } else if (rtb_Abs5 < rtP->r_fieldWeakLo) {
        /* Switch: '<S47>/Switch' incorporates:
         *  Constant: '<S45>/r_fieldWeakLo'
         *  Sum: '<S45>/Sum4'
         */
        rtb_Abs5 = rtP->r_fieldWeakLo;
      }
       ...
       *  Sum: '<S45>/Sum4'
       */
      rtb_f = (uint16_T)(((int16_T)(rtb_Abs5 - rtP->r_fieldWeakLo) << 15) /
  ...
  UnitDelay3 = -1;
  if (rtP->z_ctrlTypSel == 2) {
    rtDW->Saturation = rtDW->Merge;
    UnitDelay3 = 0;
  } else {
    rtDW->Saturation = rtDW->Merge1;
  }
  ...
  if (UnitDelay3 == 0) {
     ...
     *  Sum: '<S61>/Sum6'
     */
    rtDW->Sum1_o = -rtDW->Switch1_m - rtDW->Sum1;
    if (rtDW->Sum1_o > 32767) {
      rtDW->Sum1_o = 32767;
    } else if (rtDW->Sum1_o < -32768) {
      rtDW->Sum1_o = -32768;
    }
     ...
     *  Sum: '<S61>/Sum6'
     */
    rtb_Abs5 = (int16_T)rtDW->Switch1_m;

    /* MinMax: '<S60>/MinMax2' incorporates:
     *  MinMax: '<S60>/MinMax1'
     *  Sum: '<S61>/Sum6'
     */
    rtDW->Saturation1 = (int16_T)rtDW->Switch1_m;
     ...
     */
    if (rtDW->Switch1_m < rtDW->Sum1) {
      rtDW->Saturation1 = (int16_T)rtDW->Sum1;
    }

    /* MinMax: '<S60>/MinMax1' incorporates:
     *  Sum: '<S60>/Sum2'
     */
    if (rtb_Abs5 > rtDW->Sum1_o) {
      rtb_Abs5 = (int16_T)rtDW->Sum1_o;
    }

    /* MinMax: '<S60>/MinMax2' incorporates:
     *  Sum: '<S60>/Sum2'
     */
    if (rtDW->Saturation1 < rtDW->Sum1_o) {
      rtDW->Saturation1 = (int16_T)rtDW->Sum1_o;
    }
     ...
     *  MinMax: '<S60>/MinMax2'
     */
    rtDW->Gain3 = rtb_Abs5 + rtDW->Saturation1;
    if (rtDW->Gain3 > 32767) {
      rtDW->Gain3 = 32767;
    } else if (rtDW->Gain3 < -32768) {
      rtDW->Gain3 = -32768;
    }
     ...
     *  Sum: '<S60>/Add'
     */
    rtb_Merge1 = (int16_T)(rtDW->Gain3 >> 1);
     ...
     *  Sum: '<S60>/Sum2'
     */
    rtDW->Switch1_m = rtDW->Sum1_o - rtb_Merge1;
    if (rtDW->Switch1_m > 32767) {
      rtDW->Switch1_m = 32767;
    } else if (rtDW->Switch1_m < -32768) {
      rtDW->Switch1_m = -32768;
  ...
  if (rtb_LogicalOperator && (rtP->z_ctrlTypSel == 2)) {
     ...
     *  Merge: '<S8>/Merge'
     */
    rtb_Abs5 = rtDW->Gain4_o[0];
    rtDW->Saturation1 = rtDW->Gain4_o[1];
    rtb_Merge1 = rtDW->Gain4_o[2];
    ...
    if (rtP->b_fieldWeakEna) {
       ...
       *  SignalConversion generated from: '<S6>/r_fieldWeak '
       */
      rtb_Abs5 = (int16_T)((int16_T)((int16_T)(rtDW->OutportBufferForr_fieldWeak
        * rtDW->Switch2_a) << 2) + rtDW->Merge_c);
      rtb_Abs5 -= (int16_T)((int16_T)((int16_T)div_nde_s32_floor(rtb_Abs5, 23040)
        * 360) << 6);
    } else {
      rtb_Abs5 = rtDW->Merge_c;
    }
     ...
     *  Interpolation_n-D: '<S208>/r_sin3PhaA_M1'
     */
    Sum = plook_u8s16_evencka(rtb_Abs5, 0, 128U, 180U);
     ...
     *  Switch: '<S8>/Switch2'
     */
    rtb_Abs5 = (int16_T)((rtDW->Saturation * rtConstP.r_sin3PhaA_M1_Table[Sum]) >>
                         14);
    rtDW->Saturation1 = (int16_T)((rtDW->Saturation *
      rtConstP.r_sin3PhaB_M1_Table[Sum]) >> 14);
    rtb_Merge1 = (int16_T)((rtDW->Saturation * rtConstP.r_sin3PhaC_M1_Table[Sum])
      >> 14);
     ...
     *     Remove protection against out-of-range input in generated code: 'off'
     *   */
    rtb_Abs5 = (int16_T)(rtDW->Saturation * rtConstP.z_commutMap_M1_table
                         [rtDW->Sum1]);
    rtDW->Saturation1 = (int16_T)(rtConstP.z_commutMap_M1_table[rtDW->Sum1 + 1] *
      rtDW->Saturation);
    rtb_Merge1 = (int16_T)(rtConstP.z_commutMap_M1_table[rtDW->Sum1 + 2] *
      rtDW->Saturation);
   ...
   *  Merge: '<S3>/Merge'
   */
  rtY->a_elecAngle = (int16_T)(rtDW->Merge_c >> 6);
